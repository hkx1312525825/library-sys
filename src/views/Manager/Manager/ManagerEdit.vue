...
export default {
  ...
  created () {
    const data = this.$route.params.manager
    this.managerForm.username = data.username
    this.managerForm.password = data.password
    this.managerForm.name = data.name
    this.managerForm.phone = data.phone
    ...
    submit () {
      this.$refs.managerForm.validate((valid) => {
        if (valid) {
          ...
          axios.request({ url: `managers/${this.managerId}`, data: data, method: 'put' }).then(res => {
